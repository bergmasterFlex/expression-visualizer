...
pub fn initial_values(
    ast: &crate::model::ast::Ast,
    user_vardecl_values: &std::collections::HashMap<crate::model::node::Id, String>,
    rng: &mut impl rand::Rng,
) -> std::collections::HashMap<crate::model::node::Id, String> {
...
fn node_input_anchors(node: &crate::model::node::ENode) -> Vec<crate::model::anchor::Id> {
    node.anchors()
        .into_iter()
        .filter_map(|(aid, a)| match a {
            crate::model::anchor::EAnchor::Input { .. } => Some(aid),
            _ => None,
        })
        .collect()
}
...
fn newly_eligible_nodes(
    ast: &crate::model::ast::Ast,
    current: &std::collections::HashMap<crate::model::node::Id, String>,
) -> Vec<crate::model::node::Id> {
    let mut out = Vec::new();
    for (id, node) in &ast.nodes {
...
pub fn step_next(
    ...
    current: &std::collections::HashMap<crate::model::node::Id, String>,
    rng: &mut impl rand::Rng,
) -> Option<std::collections::HashMap<crate::model::node::Id, String>> {
